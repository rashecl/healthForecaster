...
zoomCheckbox = CheckboxGroup(labels=["Insulin/Triglycerides only"], active=[0])
...
tab3 = Panel(child = column(predictPlot_blood, row(zoomCheckbox, intMaleableInputsLayout)), title = 'My blood predictions')
